...
public class KatsLanguage extends CustomAssembly{
    @Override
    ...
    protected void populate(){
        instructionList.add(
                new BasicInstruction("hi $t1,-100",
        ...
        instructionList.add(
                new BasicInstruction("bye $t1,$t2",
        ...
        instructionList.add(
                new BasicInstruction("yes $t1, label",
